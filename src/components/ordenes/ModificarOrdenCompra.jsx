            ...
            <form onSubmit={handleSubmit} className='flex flex-col gap-2 my-4'>
                ...
                <div className='grid grid-cols-[auto_2fr] items-center gap-3'>
                    ...
                    <select
                        ...
                        disabled={orden?.id_estado_orden_compra === 2 || orden?.id_estado_orden_compra === 4}
                ...
                <div className='flex justify-around mt-4'>
                    ...
                    <ButtonLayout className={"disabled:opacity-50"} type='submit' disabled={orden === localOrden}>
                        Guardar cambios
                    </ButtonLayout>
                </div>
            </form>
